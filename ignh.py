...
def train_model(adj_matrix, index_to_name, train_dataloader,
    ...
    if gnn_model is None:
        gnn_model = IGNH(adj_matrix[0].shape[0], adj_matrix.to(device), num_classes, index_to_name, dataframe, categorical, numerical).to(device)
